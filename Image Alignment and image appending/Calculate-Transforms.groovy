...
String refStain = "panCK" //stain to use as reference image (all images will be aligned to this)
...
def AutoAlignPixelSize = 1 //downsample factor for calculating transform (tform). Does not affect scaling of output image
